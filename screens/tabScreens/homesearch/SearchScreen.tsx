        ...
        <View style={styles.container}>
            <View style={{ flexDirection: 'row', padding: 20, paddingBottom: 5, backgroundColor: 'white' }}>
                <TextInput
                    ...
                    style={{
                        height: 40, borderRadius: 10, fontSize: 14,
                        width: win.width - 110
                    }}
                    right={<TextInput.Icon style={{ marginTop: 15 }} name="microphone" color='#D0D8E0' />}
                />
                <TouchableOpacity accessibilityRole='button' accessibilityLabel='userprofile' style={{ right: 300 }} onPress={() => navigation.navigate('User')}><Text style={{ color: 'white' }} >d</Text>
                </TouchableOpacity>
